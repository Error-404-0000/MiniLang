...
Run -> save startup file -> build MiniLangCLI Release -> launch external console window`}]},{slug:"diagnostics",title:"Diagnostics",section:"Tooling",topic:"diagnostics",summary:"MiniLang diagnostics explain syntax, scope, interop, and collection mistakes in both the CLI and Studio.",whatItIs:"Diagnostics are the structured errors and warnings returned by the analysis and runtime hosts when MiniLang code is invalid.",whyItExists:"Once a language grows past toy examples, users need source-linked feedback rather than vague exceptions.",syntax:"Diagnostics currently surface with an id, severity, message, line, column, start offset, and length.",pitfalls:"Do not ignore analysis failures just because the runtime still builds; syntax and scope diagnostics usually point at real broken behavior.",bestPractices:"Fix the first syntax or scope error before chasing follow-up diagnostics, and use `inspect-json` when you want the raw diagnostic payload.",compilerView:"The legacy host catches interpreter and runtime exceptions, maps them to source offsets, then sends the normalized diagnostics to the CLI and Studio.",examples:[{topic:"diagnostics",title:"Indexing a non-array value",code:`fn number Main(){
    ...
    give 0;
}`,result:"Error ML0001: Cannot foreach over non-array target 'value'."}]},{slug:"compiler-internals",title:"Compiler internals",section:"Internals",topic:"compiler-internals",summary:"How the active legacy MiniLang pipeline tokenizes, groups, validates, interprets, and executes source files today.",whatItIs:"Compiler Internals documents the actual architecture of the legacy runtime that powers the current language, CLI, and Studio.",whyItExists:"The codebase is growing into a larger ecosystem, so the real pipeline needs to be understandable and documented instead of hidden behind vague marketing language.",syntax:"The current pipeline is: raw source -> tokenizer -> parser grouping -> structured token builder -> grammar validation/interpreter -> runtime engine.",pitfalls:"Do not confuse the legacy runtime path with the separate experimental newer compiler stack elsewhere in the repository.",bestPractices:"When adding a language feature, update tokenization, grouping, validation, runtime execution, tests, and docs together.",compilerView:"Arrays and foreach follow the same rule: they start as tokens, become structured syntax objects, are validated in grammar/expression analysis, then execute through runtime-specific handlers.",examples:[{topic:"compiler-internals",title:"Legacy analysis flow",code:"Source text -> Tokenizer -> Parser -> TokenBuilder -> GrammarInterpreter -> LegacyMiniLangHost.AnalyzeSource"},{topic:"compiler-internals",title:"Legacy runtime flow",code:"Interpreted tokens -> RuntimeEngine -> RuntimeExpressionEvaluator -> builtin executables / user functions / interop bridge"}]}];a.s(["docsPages",0,b,"getDocNeighbors",0,function(a){let c=b.findIndex(b=>b.slug===a);return{previous:c>0?b[c-1]:null,next:c>=0&&c<b.length-1?b[c+1]:null}},"getDocPage",0,function(a){return b.find(b=>b.slug===a)}])},29592,a=>{"use strict";a.s(["SearchPanel",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call SearchPanel() from the server but SearchPanel is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/components/SearchPanel.tsx <module evaluation>","SearchPanel")},24692,a=>{"use strict";a.s(["SearchPanel",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call SearchPanel() from the server but SearchPanel is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/components/SearchPanel.tsx","SearchPanel")},4816,a=>{"use strict";a.i(29592);var b=a.i(24692);a.n(b)},60168,a=>{"use strict";var b=a.i(7997),c=a.i(95936),d=a.i(4816),e=a.i(4487);a.s(["default",0,function(){return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsxs)("section",{className:"hero",children:[(0,b.jsxs)("div",{className:"hero-panel",children:[(0,b.jsx)("span",{className:"section-label",children:"Serious language ecosystem"}),(0,b.jsx)("h1",{children:"MiniLang is now documenting the real legacy runtime, not an imagined future shell."}),(0,b.jsxs)("p",{children:["The active platform combines the legacy MiniLang runtime, Monaco-based MiniLang Studio, reusable workspace libraries, a safe Windows interop bridge, new collection features like arrays and ",(0,b.jsx)("code",{children:"foreach"}),", and an official docs site built around topic-accurate examples with expected results."]}),(0,b.jsxs)("div",{className:"feature-grid",children:[(0,b.jsxs)("div",{className:"feature-card",children:[(0,b.jsx)("strong",{children:"Language"}),(0,b.jsx)("p",{className:"muted",children:"Legacy MiniLang runtime with enums, arrays, foreach, indexing, and reusable functions."})]}),(0,b.jsxs)("div",{className:"feature-card",children:[(0,b.jsx)("strong",{children:"Studio"}),(0,b.jsx)("p",{className:"muted",children:"WinUI host, Monaco editor, startup files, diagnostics, Release console runs, and structured inspectors."})]}),(0,b.jsxs)("div",{className:"feature-card",children:[(0,b.jsx)("strong",{children:"Interop"}),(0,b.jsx)("p",{className:"muted",children:"Safe user-mode process, time, console, IO, and user helpers exposed through the `win` bridge."})]}),(0,b.jsxs)("div",{className:"feature-card",children:[(0,b.jsx)("strong",{children:"Reusable Workspace"}),(0,b.jsx)("p",{className:"muted",children:"Core, Console, IO, Window, and Collections libraries plus runnable startup apps under a real folder layout."})]})]}),(0,b.jsx)("p",{children:(0,b.jsx)(c.default,{href:"/docs/getting-started",className:"section-label",children:"Open the docs"})})]}),(0,b.jsx)(d.SearchPanel,{})]}),(0,b.jsxs)("section",{className:"hero-panel",style:{marginTop:24},children:[(0,b.jsx)("span",{className:"section-label",children:"Documentation map"}),(0,b.jsx)("div",{className:"feature-grid",children:e.docsPages.map(a=>(0,b.jsxs)(c.default,{href:`/docs/${a.slug}`,className:"feature-card",children:[(0,b.jsx)("strong",{children:a.title}),(0,b.jsx)("p",{className:"muted",children:a.summary})]},a.slug))})]})]})}])},28004,a=>{a.n(a.i(60168))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0rlxes3._.js.map